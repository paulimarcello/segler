defmodule Aufbereitung.Model.Merkmal do
  ...
  def new_logisch(id, erfuellung) when is_number(id) and
  ...
  def new_auswahl(id, auspraegungen) when is_number(id) and is_list(auspraegungen) do
    %Merkmal{id: id, typ: :auswahl, data: auspraegungen}
  end
  ...
  def new_selbstbeteiligung(id, auspraegungen) when is_number(id) and is_list(auspraegungen) do
    %Merkmal{id: id, typ: :sb, data: auspraegungen}
  end
  ...
  #--------------------------------------------------------------------------------------------------
#todo!
  def splitte(m1 = %Merkmal{id: id, typ: :auswahl, data: _left}, %Merkmal{id: id, typ: :auswahl, data: _right}) do
    [m1]
  end
end
